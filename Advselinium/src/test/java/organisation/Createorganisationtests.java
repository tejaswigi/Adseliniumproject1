...
public class Createorganisationtests extends Baseclass
{
	...
	public void createorganisation() throws Throwable
	{
		...
		home.clickorganisationlinktext();
		Organisationcreationpage1 org=new Organisationcreationpage1(driver);
		org.clickorganisationcreateimage();
		Java_utility jlib=new Java_utility();
		int RanNum=jlib.getRandomNum();
		Excel_utility elib=new Excel_utility();
		String exceldata=elib.getExcelData("organisation",0,0)+RanNum;
		org.organisationnamestextfield(exceldata);
		org.savebutton();
